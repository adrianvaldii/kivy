...
class TakePhotoWindow(Screen):    
    ...
    def capture(self):
        ...
        camera.export_to_png("image/counting.bmp")
        #TakePhotoWindow.switch_(self, ['D:\\INOVASI Project\KIVY\Kivy_CountingIron\\image\\IMG_{}.png'.format(timestr)])
        TakePhotoWindow.switch_(self,['D:\\INOVASI Project\\KIVY\\Kivy_CountingIron\\image\\counting.png'])
        print("Captured")
...
class FileChooserWindow(Screen):   
    ...
    def load(self, path, filename):
        ...
        cv2.imwrite("image/counting.bmp",img)        
        FileChooserWindow.switch(self,['D:\\INOVASI Project\\KIVY\\Kivy_CountingIron\\image\\coba2.jpeg'])
        print(filename)
        print(filename[0])
...
class CountingWindow(Screen):    
    ...
    def counting(self):
        img_original = cv2.imread('image/coba2.jpeg')
