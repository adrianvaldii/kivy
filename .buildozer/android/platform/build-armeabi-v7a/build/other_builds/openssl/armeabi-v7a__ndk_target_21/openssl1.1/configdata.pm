...
our %config = (
  ...
  CPPFLAGS => [ "-DANDROID -D__ANDROID_API__=21 -I/home/windi/.buildozer/android/platform/android-ndk-r19c/sysroot/usr/include/arm-linux-androideabi -I/home/windi/kivy/.buildozer/android/platform/build-armeabi-v7a/build/python-installs/countingsteelbar/include/python3.8" ],
  CPPINCLUDES => [  ],
  ...
  LDFLAGS => [ "  -L/home/windi/kivy/.buildozer/android/platform/build-armeabi-v7a/build/libs_collections/countingsteelbar/armeabi-v7a" ],
  LDLIBS => [ "-lm" ],
  PERL => "/usr/bin/perl",
  RANLIB => ":",
  RC => "windres",
